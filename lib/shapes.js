...
class SVG {
    ...
    render() {
        return `<svg width="300" height="200" xmlns="http://www.w3.org/2000/svg"><text><tspan font-weight="bold" fill="${this.textcolor}">${this.text}</tspan></text>${this.shape}</svg>`
    }
};
...
class Square extends Shapes {
    ...
    render() {
        return `<rect x="10" y="10" width="100" height="100" stroke="${this.color}" fill="${this.color}" stroke-width="5"/>`
    }
};
